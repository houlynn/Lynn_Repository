...
public class ModelInterceptor extends EmptyInterceptor {
	...
	public void onDelete(Object entity, Serializable id, Object[] state,
		...
		LOG.info("onPreDelete： "+model.getClass().getSimpleName() +"("+ model.getDescription()+")");
	...
	public boolean onFlushDirty(Object entity, Serializable id,
			...
			String[] propertyNames, Type[] types) {
		Model model=(Model)entity;
		LOG.info("preUpdate " + model.getClass().getSimpleName() +"("+ model.getDescription()+")");
		for (ModelHandler modelHandler : modelHandlers) {
	...
	public boolean onSave(Object entity, Serializable id, Object[] state,
			String[] propertyNames, Type[] types) {
		Model model=(Model)entity;
		LOG.info("preSave " + model.getClass().getSimpleName() +"("+ model.getDescription()+")");
		for (ModelHandler modelHandler : modelHandlers) {
