...
public class AppBaseController  {
	 ...
	 * @throws Exception
	 */
	public <T extends Model> void remove(Class<T> clazz,String id) throws Exception{
	 ...
	 * @return
	 */
	public  <T extends Model> T findByOId(Class<T> clazz, String id) throws Exception{
	 ...
	 * @throws Exception
	 */
	public  <T extends Model> T getEntityByHql(Class<T> clazz,
	 ...
	 * @param resModel
	 */
	protected void toWritePhone(HttpServletResponse response, ResultModel resultModel){
