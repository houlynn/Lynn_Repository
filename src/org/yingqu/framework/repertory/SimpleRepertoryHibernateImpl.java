...
public abstract class SimpleRepertoryHibernateImpl<M extends BaseEntity> implements ISimpleRepertory<M> {
	...
	protected SimpleRepertoryHibernateImpl(Class<? extends BaseEntity> clazz)
	{
		this.clazz=clazz;
